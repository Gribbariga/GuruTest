...
const AdsItem = ({data}) => {
    ...
    const {oldPrice, price, title, locality, date, seen} = data

    return (
        <div className="ads-item">
            <AdsItemSlider seen={seen}/>
            <div className={`ads-item__wrapper ${seen?"ads-item__wrapper--visited":null} `}>
                <div className="ads-item__top-wrapper">
                    <div className="ads-item__price-wrapper">
                        <div className="ads-item__old-price"> {oldPrice} <span id='rub-small'>P</span> </div>
                        <div className="ads-item__price">{price} <span id="rub-big">P</span> </div>
                    </div>
                    <div className="ads-item__icon-wrapper">
                        <div  className="ads-item__icon-grey" >
                            {delivery}
                        </div>
                        <div  className="ads-item__icon-grey" >
                            {transaction}
                ...
                <div className="ads-item__descr">{title}</div>
                <div className="ads-item__footer">
                    <div className="ads-item__city">{locality}</div>
                    <div className="ads-item__data-time">{`${date.day}.${date.month}.${date.year}, ${date.hours}.${date.minutes}`}</div>
                </div>
            </div>
        </div>
    )
